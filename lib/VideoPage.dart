...
class VideoPage extends StatefulWidget {
  ...
  final Map<String, String> videoUris; // This will hold video paths based on language
...
class _VideoPageState extends State<VideoPage> {
  ...
  void _initializeVideo(String language) {
    if (_videoController != null) {
      _videoController!.dispose(); // Dispose of the old controller if it exists
    }
    // Use VideoPlayerController.asset for local video files
  ...
  void handleButtonPress() {
    if (widget.patientId == 'guest') {
      Navigator.pushNamed(context, '/PatientDashboard1');
    } else {
      Navigator.pushNamed(
        context,
        '/FeedbackScreen',
        arguments: {
          'videoId': widget.videoUris[selectedLanguage!],
